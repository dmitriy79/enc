...
-----------------------
Building the dependencies and Encocoin Core requires some essential build tools and libraries to be installed before.
...
Add `CC=egcc CXX=eg++ CPP=ecpp` to the dependencies build and the Encocoin Core build:
```bash
$ cd depends
