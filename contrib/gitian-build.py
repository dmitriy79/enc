...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/encocoinpay/gitian.sigs.git'])
    if not os.path.isdir('encocoin-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/encocoinpay/encocoin-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('encocoin'):
        subprocess.check_call(['git', 'clone', 'https://github.com/encocoinpay/encocoin.git'])
...
def build():
    ...
    os.makedirs('encocoincore-binaries/' + args.version, exist_ok=True)
    ...
    if args.linux:
        ...
        subprocess.check_call('mv build/out/encocoincore-*.tar.gz build/out/src/encocoincore-*.tar.gz ../encocoincore-binaries/'+args.version, shell=True)
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/encocoincore-*-win-unsigned.tar.gz inputs/encocoincore-win-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/encocoincore-*.zip build/out/encocoincore-*.exe ../encocoincore-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/encocoincore-*-osx-unsigned.tar.gz inputs/encocoincore-osx-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/encocoincore-*.tar.gz build/out/encocoincore-*.dmg ../encocoincore-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call(['bin/gbuild', '-i', '--commit', 'signature='+args.commit, '../encocoin/contrib/gitian-descriptors/gitian-win-signer.yml'])
        ...
        subprocess.check_call('mv build/out/encocoincore-*win64-setup.exe ../encocoincore-binaries/'+args.version, shell=True)
        subprocess.check_call('mv build/out/encocoincore-*win32-setup.exe ../encocoincore-binaries/'+args.version, shell=True)

    if args.macos:
        print('\nSigning ' + args.version + ' MacOS')
        subprocess.check_call(['bin/gbuild', '-i', '--commit', 'signature='+args.commit, '../encocoin/contrib/gitian-descriptors/gitian-osx-signer.yml'])
        ...
        subprocess.check_call('mv build/out/encocoincore-osx-signed.dmg ../encocoincore-binaries/'+args.version+'/encocoincore-'+args.version+'-osx.dmg', shell=True)
...
def verify():
    ...
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-linux', '../encocoin/contrib/gitian-descriptors/gitian-linux.yml'])
    print('\nVerifying v'+args.version+' Windows\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-unsigned', '../encocoin/contrib/gitian-descriptors/gitian-win.yml'])
    print('\nVerifying v'+args.version+' MacOS\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-unsigned', '../encocoin/contrib/gitian-descriptors/gitian-osx.yml'])
    print('\nVerifying v'+args.version+' Signed Windows\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-signed', '../encocoin/contrib/gitian-descriptors/gitian-win-signer.yml'])
    print('\nVerifying v'+args.version+' Signed MacOS\n')
    subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-signed', '../encocoin/contrib/gitian-descriptors/gitian-osx-signer.yml'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/encocoinpay/encocoin', help='Specify the URL of the repository. Default is %(default)s')
