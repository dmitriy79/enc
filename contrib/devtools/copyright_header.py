...
Arguments:
    <base_directory> - The base directory of a Encocoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Encocoin Core developers'
...
Arguments:
    <base_directory> - The base directory of Encocoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Encocoin Core repository.
"""
