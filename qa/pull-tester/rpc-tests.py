...
BASE_SCRIPTS= [
    ...
    'dip3-deterministicmns.py', # NOTE: needs encocoin_hash to pass
    'wallet-hd.py',
    'walletbackup.py',
    ...
    'listtransactions.py',
    'multikeysporks.py',
    'llmq-signing.py', # NOTE: needs encocoin_hash to pass
    'llmq-chainlocks.py', # NOTE: needs encocoin_hash to pass
    'llmq-simplepose.py', # NOTE: needs encocoin_hash to pass
    'llmq-is-cl-conflicts.py', # NOTE: needs encocoin_hash to pass
    'llmq-dkgerrors.py', # NOTE: needs encocoin_hash to pass
    'dip4-coinbasemerkleroots.py', # NOTE: needs encocoin_hash to pass
...
ZMQ_SCRIPTS = [
    # ZMQ test can only be run if Encocoin Core was built with zmq-enabled.
