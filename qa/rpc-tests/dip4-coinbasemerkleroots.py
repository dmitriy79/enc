...
class LLMQCoinbaseCommitmentsTest(EncocoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as EncocoinTestFramework doesn't support this atm)
